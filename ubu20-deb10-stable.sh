...
clear;clear;clear
  ...
  # // Banner
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo -e "  Auther : ${green}  AutoScript By Reine ® ${NC}${YELLOW}(${NC} ${green} ANJAY POKONAMAH ${NC}${YELLOW})${NC}"
echo -e "${YELLOW}----------------------------------------------------------${NC}"
echo ""
sleep 2
###### IZIN SC 
...
clear
# REPO    
    REPO="https://raw.githubusercontent.com/silverhistoria/sc/main/"
...
echo -e "\e[32mloading...\e[0m" 
clear
izinsc="https://raw.githubusercontent.com/silverhistoria/izin/main/ip"
# USERNAME
rm -f /usr/bin/user
...
wget -q https://raw.githubusercontent.com/silverhistoria/sc/main/config/fv-tunnel && chmod +x fv-tunnel && ./fv-tunnel
